...
| **ხაზების გადაკვეთა** / Line crossings | იგივე ლოგიკა ორ **ხაზოვან** shapefile-ზე (მაგ. გაზსადენი × კომუნიკაცია) — პოულობს **წერტილებს, სადაც ხაზები იკვეთება** (`line ∩ line`). გეომეტრია ავტომატურად ცნობს: პოლიგონი→საზღვარი, ხაზი→თავად ხაზი. ზუსტად ისეთივე გამოტანა — დანომრილი წერტილოვანი shapefile (`.prj`-თი) + **„Shp → კოორდინატები“** / Excel. |
